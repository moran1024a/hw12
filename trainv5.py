...
# 2. 仅在“环境 reset / seed 采样”处加入 badseed 课程采样逻辑
# 3. 新增 badseedlist.csv 读取
# 4. 新增按训练进度线性提升 badseed 采样率
# 5. 在修改处保留原代码注释，并标明【修改】/【新增】
# ==============================================================
...
badseed_warmup_end = 0.30               # 【新增】阶段1结束进度
badseed_ramp_end = 0.70                 # 【新增】阶段2结束进度
badseed_ratio_start = 0.05              # 【新增】前期 badseed 采样率
badseed_ratio_mid = 0.30                # 【新增】中期 badseed 采样率
badseed_ratio_end = 0.50                # 【新增】后期 badseed 采样率
